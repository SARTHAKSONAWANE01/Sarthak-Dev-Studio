...
export const projects: Project[] = [
  ...
  },
  {
    ...
    shortOutcome: "A luxury design portfolio and booking experience for a creative art studio.",
    description:
      "A bespoke portfolio showcase and scheduling platform built for Ankita's Studio, a boutique creative art and design firm. Features interactive layouts, dynamic product galleries, and custom appointment workflows.",
    tier: 1,
    ...
    caseStudy: {
      overview:
        "Ankita's Studio needed a web presence that acts as both an art gallery and a client booking channel. The goal was to build a visually engaging, high-performance, and responsive design that drives commissions.",
      problem:
        "Boutique studios often fail to showcase high-resolution artwork effectively without sacrificing load times or mobile responsiveness.",
      research:
        "Studied luxury gallery layouts, image optimization algorithms, and simple calendar booking APIs to reduce client friction.",
      approach:
        "Combined React with Sanity CMS for flexible art curation. Applied custom lazy-loading logic and Framer Motion transitions for elegant entrance animations.",
      development:
        "Built responsive image grids, configured webhook notifications for new client inquiries, and custom booking schedules.",
      challenges:
        "Serving ultra-high-resolution images on mobile platforms while maintaining smooth scroll performance.",
      results:
        "A 40% increase in monthly workshop bookings and a clean digital catalog displaying over 50 custom art pieces.",
      gallery: [],
      lessonsLearned:
        "Visual storytelling is paramount for creative spaces. Restricting copy and emphasizing fluid layout movements lets the art work take center stage.",
      nextSteps:
        "Integrating an e-commerce print shop and automated scheduling calendar tools.",
      metrics:
        "40% Booking Increase · Sub-2s Load Times · Sanity CMS Integration · 100% Mobile Score",
    },
  },
  {
    slug: "bitdevxp",
  ...
  },
  {
    ...
    caseStudy: {
      ...
      approach:
        "Layered composition: background parallax, mid-ground content reveals, and foreground interactive elements. Each section was designed as 'scene' in a larger story. Performance budgets were set before development began.",
      development:
